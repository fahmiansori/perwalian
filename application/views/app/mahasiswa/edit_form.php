                ...
                <div class="body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input value="<?php echo $data_detail->nim; ?>" type="text" id="nim" name="nim" class="form-control <?php echo form_error('nim') ? 'error':'' ?>" placeholder="Masukkan NIM" required>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input value="<?php echo $data_detail->tahun_masuk; ?>" type="number" id="tahun_masuk" name="tahun_masuk" class="form-control <?php echo form_error('tahun_masuk') ? 'error':'' ?>" placeholder="Masukkan tahun" required>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input  value="<?php echo $data_detail->nama_mahasiswa; ?>" type="text" id="nama_mahasiswa" name="nama_mahasiswa" class="form-control <?php echo form_error('nama_mahasiswa') ? 'error':'' ?>" placeholder="Masukkan nama user" required>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <textarea type="text" id="alamat_mahasiswa" name="alamat_mahasiswa" class="form-control <?php echo form_error('alamat_mahasiswa') ? 'error':'' ?>" placeholder="Masukkan alamat" required rows="8" cols="80"><?php echo $data_detail->alamat_mahasiswa; ?></textarea>
                            </div>
                            ...
                            <div class="form-line">
                                <select id="program_studi_id" name="program_studi_id" class="form-control show-tick <?php echo form_error('program_studi_id') ? 'error':'' ?>" required>
                                    ...
                                    <?php foreach ($program_studi as $row): ?>
                                        <option value="<?php echo $row->id; ?>" <?php echo $data_detail->program_studi_id==$row->id ? 'selected':'' ?>><?php echo $row->nama_prodi; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
