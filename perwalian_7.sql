...
INSERT INTO `dosen` (`id`, `nip`, `nama_dosen`, `alamat_dosen`, `user_id`) VALUES
	(3, '1111', 'dosen wali', 'alamatan dosne', 26);
...
-- Dumping data for table perwalian.jadwal_perwalian: ~3 rows (approximately)
...
INSERT INTO `jadwal_perwalian` (`id`, `nim`, `dosen_id`, `user_id`, `waktu`, `semester`, `status`) VALUES
	...
	(9, '11213', 3, 1, '2020-08-18 10:26:00', 6, 'waiting');
...
-- Dumping data for table perwalian.mahasiswa: ~0 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `full_name`, `role`, `last_login`, `photo`, `created_at`, `is_active`) VALUES
	(1, 'admin', '$2y$10$1kOWVTY47Fp3rLNma6wTEeqYyNS0ARJBQW7onIoaUZ74ZfH5hMVv2', NULL, 'Administrator', 1, '2020-08-18 17:06:48', NULL, '2020-08-11 14:51:43', 1),
	...
	(26, 'dosen', '$2y$10$tkvEyyuH9Tvn.JLESrd.4O9rulS1ha8Qb06eCdWn1Qfii1EsQcKwe', NULL, 'dosen wali', 2, '2020-08-18 15:30:04', NULL, '2020-08-13 15:21:29', 1),
	...
	(28, 'mahasiswa', '$2y$10$LGS8EV05UQvXfVlwDK/FoeavsUQJ6PXXqbj2npkY0oNPRAiCXmlqm', NULL, 'nama', 3, '2020-08-18 14:58:19', NULL, '2020-08-18 10:14:18', 1);
